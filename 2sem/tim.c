...
int bin_search(int num, char* str, elem* inp, int end)
{
    int left=0, right=end, mid=(int)((left+right)/2);
    while(1)
    {
...
int main()
{
    ...
    elem *output=merge_sort(a,b,0,abc-1);
